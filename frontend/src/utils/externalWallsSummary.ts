...
export function formatExternalWallsSummary(
  ...
  const insul =
    ...
    (ew.insulationPresetId
      ? ({ id: ew.insulationPresetId, material: ew.insulationPresetId, construction: 'утеплювач' } as EnvelopePreset)
      : null);
